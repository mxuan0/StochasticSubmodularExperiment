...
def influence_by_advertiser(x, edge_prob, customer_to_phrase, budget_limit_phrase, budget_limit_total):
    ...
    for customer in customer_to_phrase:
        influence += influence_on_customer(x, customer, edge_prob, customer_to_phrase[customer])
    
    return influence

def total_influence(weight_per_advertiser, budget_per_advertiser, edge_prob, customer_to_phrase, 
                    budget_limit_phrase, budget_limit_total):
    '''
    ...
    for i in tqdm(range(len(weight_per_advertiser))):
        influence += weight_per_advertiser[i] * \
            influence_by_advertiser(budget_per_advertiser[i], edge_prob, customer_to_phrase, budget_limit_phrase, budget_limit_total)
    return influence
...
print(total_influence(weights, intial_budget, edge_weights, customer_to_phrase, phrase_price, avp))